...
void main() {
  ...
  // 상속의 방법이 아닌 [컴포지션 방법]으로 다른 클래스 사용하기
  // Hyundai 클래스 생성시 K엔진 클래스를 내부에 생성함 ->  HyunDai(K_Engine()) ===>>> K_Engine() 이 괄호가 제일 중요함
  HyunDai hd = HyunDai(K_Engine());
  print('현대차 엔진 파워:${hd.k_engine.power}마력');
  print('현대차 주행거리 :${hd.k_engine.distance}km');
